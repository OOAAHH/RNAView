...
- counts: `{'ok': 4, 'changed': 0, 'unapproved': 11, 'failed': 0}`
...
- unapproved: `test/mmcif/insertion_code/4ARC/4ARC.cif` job_id=`4ARC__ab9c7e43` events=2
...
- unapproved: `test/mmcif/x-ray/4NMG/assembly-1/4nmg-assembly1.cif` job_id=`4nmg-assembly1__2f46a8f9` events=2
- unapproved: `test/pdb/pdb1nvy/pdb1nvy.ent` job_id=`pdb1nvy__e152e1d2` events=2
- unapproved: `test/pdb/pdb1nvy/pdb1nvy.pdb` job_id=`pdb1nvy__93035b1b` events=2
- unapproved: `test/pdb/test1/test1.pdb` job_id=`test1__704911ff` events=2
